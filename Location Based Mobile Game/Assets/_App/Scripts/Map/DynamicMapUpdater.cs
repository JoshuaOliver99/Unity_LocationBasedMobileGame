...
namespace Maps.Shared
{
    ...
    /// area.
    /// It uses the <see cref="MapLoader"/> for the loading of the map,
    ...
    public class DynamicMapUpdater : MonoBehaviour
    {
        ...
        /// </summary>
        public MapLoader BaseMapLoader;
        ...
        void Awake()
        {
            ...
            {
                Debug.LogError(MapErrors.MissingParameter(
        ...
        private bool VerifyParameters()
        {
            ...
            if (Ground == null)
            {
                Debug.LogError(MapErrors.MissingParameter(this, Ground, "Ground"));
            ...
            if (Camera.main == null)
            {
                Debug.LogError(MapErrors.NullMainCamera(this));

                return false;
            }

            // If have reached this point then we have verified all required paramvvveters.
            return true;
        }
